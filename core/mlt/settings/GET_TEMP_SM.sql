/*delete from sm_r_process_events where process_code='GET_TEMPLATE' and event_code='GET_TEMPLATE';
delete from sm_r_process_events where event_code='GET_TEMPLATE';
delete from sm_r_event_procedures where event_code='GET_TEMPLATE';
delete from sm_r_events where event_code='GET_TEMPLATE';
delete from sm_r_processes where process_code = 'GET_TEMPLATE';
*/
...
values
  ('GET_TEMPLATE', 'MLT_GET', 'ROOT', 'A', NULL,'', sysdate, 'ASILBEK', 'Y','CREATED','GET',null,null,null);
