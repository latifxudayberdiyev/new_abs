...
(function () {
    ...
    window.initElement = function (t) {
        ...
        if (t.tagName == "SELECT") {
            ...
            //if(is.def(t.form) && t.form.name == "tblForm" && t.type == "checkbox") return;
            if (is.undef(t.sid)) {
...
window.onload = function () {
    /*try {
        ...
        script.src = _.URL.substring(0, ((_.URL.indexOf("/ibs/")>-1)?_.URL.indexOf("/ibs/"):_.URL.indexOf("/dwh/")) + 1) + "tocmat_url.js";
 ...
 * va submit knopkasi disable qiladi
 */
function formReadOnly() {
    ...
    for (var i = 0; i < inputs.length; i++) {
        ...
        for (var j = 0; j < obj.length; j++) {
            if (obj[j].type == "text" || obj[j].type == "password" || inputs[i] == "textarea") {
                ...
                obj[j].options.length = 1;
            } else if (obj[j].type == "submit") {
