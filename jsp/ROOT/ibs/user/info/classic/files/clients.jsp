...
<head>
  ...
  <link type="text/css" rel="stylesheet" href="../icons/icons.css">
  <link type="text/css" rel="stylesheet" href="../font/roboto/css.css">
  <link type="text/css" rel="stylesheet" href="css/style_cl.css">
<script>
...
<div id="waitImage" style="display:none;" >
	<img src="img/ajax-loader6.gif"  alt="Загрузка" id="loadingImage" style="margin:50px 50px 10px 50px;"/><br>
	<p style="margin-top: 5px;font: 14px Verdana, sans-serif;font-weight:600;"><%= lang.get(si_loading)%></p>
</div>
	<form>
		<div class="searchbox">
	...
	<div class="client-content" id="clients">
