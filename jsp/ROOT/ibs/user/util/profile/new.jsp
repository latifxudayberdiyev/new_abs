...
<table align=center class=formToolbar cellspacing=2>
	<tr>
		<td><input type=submit name=save value="<%= lang.get(si_save) %>">
</table>
...
static final int si_formTitle = SI("Фото","Сурат","Surat","");
static final int si_save      = SI("Сохранить","Са&#1179;лаш","Saqlash","");
static final int si_file      = SI("Путь файла","Файл йўли","Fayl yo`li","");
//-------------------------------------------------------------------------------------------------
