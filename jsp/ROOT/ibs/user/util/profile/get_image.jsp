...
//-------------------------------------------------------------------------------------------------
	...
	try {
		String sqlCmd = "select Core_Adm_Api.Get_Image("+Util.parseInt(id)+",'"+Util.quotesSQL(image_type)+"') from dual";
		if("FACE".equals(image_type) || "FACE_CAPTURED".equals(image_type) || "FACE_MATCHED".equals(image_type)) {
			sqlCmd = "select Bio_Api.Get_Image("+Util.parseInt(id)+",'"+Util.quotesSQL(image_type)+"') from dual";
		}
