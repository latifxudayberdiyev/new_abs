!function (t, e) {
    ...
    class o {
        ...
        open() {
            ...
            if (t.length) {
                const e = t[t.length - 1].id, s = this.content.list.querySelector('[data-id="' + e + '"]');
        ...
        mainDiv() {
            ...
            !this.settings.allowDeselect || this.settings.isMultiple && n && n.length <= 0 ? i.classList.add(this.classes.hide) : i.classList.remove(this.classes.hide), i.onclick = t => {
                ...
                if (this.callbacks.beforeChange && (e = !0 === this.callbacks.beforeChange(i, s)), e) {
                    if (this.settings.isMultiple) this.callbacks.setSelected([], !1), this.updateDeselectAll(); else {
                        const t = this.store.getFirstOption(), e = t ? t.id : "";
            ...
            return c.setAttribute("d", this.classes.arrowClose), this.settings.alwaysOpen && o.classList.add(this.classes.hide), o.appendChild(c), e.appendChild(o), {
                main: e,
                values: s,
        ...
        renderSingleValue() {
            const t = this.store.filter((t => t.selected && !t.placeholder), !1), e = t.length > 0 ? t[0] : null;
            if (e) {
        ...
        renderMultipleValues() {
            let t = this.main.values.childNodes, e = this.store.filter((t => t.selected && t.display), !1);
            ...
            for (let i = 0; i < t.length; i++) {
                const n = t[i], a = n.getAttribute("data-id");
                if (a) {
        ...
        multipleValue(t) {
            ...
            if (s.classList.add(this.classes.valueText), s.textContent = t.text, e.appendChild(s), !t.mandatory) {
                ...
                s.classList.add(this.classes.valueDelete), s.onclick = e => {
                    ...
                    let s = !0;
                    const i = this.store.getSelectedOptions(), l = i.filter((e => e.selected && e.id !== t.id), !0);
        ...
        searchDiv() {
            const t = document.createElement("div"), e = document.createElement("input"),
                i = document.createElement("div");
            t.classList.add(this.classes.search);
            const n = {main: t, input: e};
            if (this.settings.showSearch || (t.classList.add(this.classes.hide), e.readOnly = !0), e.classList.add("fb-form-control"), e.type = "search", e.placeholder = this.settings.searchPlaceholder, e.tabIndex = -1, e.setAttribute("aria-label", this.settings.searchPlaceholder), e.setAttribute("autocapitalize", "off"), e.setAttribute("autocomplete", "off"), e.setAttribute("autocorrect", "off"), e.oninput = s((t => {
                ...
                }, t.appendChild(i), n.addable = {main: i, svg: e, path: s}
            }
            return n
        }
        ...
        renderOptions(t) {
            ...
            for (const s of t) {
                if (s instanceof n) {
                    ...
                    const i = document.createElement("div");
                    i.classList.add(this.classes.optgroupLabel), t.appendChild(i);
                    const n = document.createElement("div");
                    n.classList.add(this.classes.optgroupLabelText), n.textContent = s.label, i.appendChild(n);
                    const a = document.createElement("div");
                    if (a.classList.add(this.classes.optgroupActions), i.appendChild(a), this.settings.isMultiple && s.selectAll) {
                        const t = document.createElement("div");
                        t.classList.add(this.classes.optgroupSelectAll);
                        let e = !0;
                        for (const t of s.options) if (!t.selected) {
                            e = !1;
                            break
                        }
                        e && t.classList.add(this.classes.selected);
                        const i = document.createElement("span");
                        i.textContent = s.selectAllText, t.appendChild(i);
                        const n = document.createElementNS("http://www.w3.org/2000/svg", "svg");
                        n.setAttribute("viewBox", "0 0 100 100"), t.appendChild(n);
                        const l = document.createElementNS("http://www.w3.org/2000/svg", "path");
                        l.setAttribute("d", this.classes.optgroupSelectAllBox), n.appendChild(l);
                        const o = document.createElementNS("http://www.w3.org/2000/svg", "path");
                        o.setAttribute("d", this.classes.optgroupSelectAllCheck), n.appendChild(o), t.addEventListener("click", (t => {
                            t.preventDefault(), t.stopPropagation();
                            const i = this.store.getSelected();
                            if (e) {
                                const t = i.filter((t => {
                                    for (const e of s.options) if (t === e.id) return !1;
                                    return !0
                                }));
                                this.callbacks.setSelected(t, !0)
                            } else {
                                const t = i.concat(s.options.map((t => t.id)));
                                for (const t of s.options) this.store.getOptionByID(t.id) || this.callbacks.addOption(t);
                                this.callbacks.setSelected(t, !0)
                            }
                        })), a.appendChild(t)
                    }
                    ...
                    t.appendChild(i);
                    for (const i of s.options) t.appendChild(this.option(i)), e.appendChild(t)
                }
                s instanceof a && e.appendChild(this.option(s))
            }
        ...
        option(t) {
            ...
            return e.dataset.id = t.id, e.classList.add(this.classes.option), e.setAttribute("role", "option"), t.class && t.class.split(" ").forEach((t => {
                ...
                const s = this.store.getSelected(), i = e.currentTarget, n = String(i.dataset.id);
        ...
        highlightText(t, e, s) {
            ...
            const a = t.match(n).index, l = a + t.match(n)[0].toString().length, o = t.substring(a, l);
        ...
        ensureElementInView(t, e) {
            const s = t.scrollTop + t.offsetTop, i = s + t.clientHeight, n = e.offsetTop, a = n + e.clientHeight;
        ...
        updateDeselectAll() {
            ...
            const t = this.store.getSelectedOptions(), e = t && t.length > 0, s = this.settings.isMultiple,
    ...
    class c {
        constructor(t) {
            this.listen = !1, this.observer = null, this.select = t, this.valueChange = this.valueChange.bind(this), this.select.addEventListener("change", this.valueChange, {passive: !0}), this.observer = new MutationObserver(this.observeCall.bind(this)), this.changeListen(!0)
        }
    ...
    return class {
        constructor(e) {
            ...
            this.selectEl.dataset.ssid && this.destroy(), this.settings = new h(e.settings), this.cssClasses = new t(e.cssClasses);
