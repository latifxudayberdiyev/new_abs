...
%></script></t:request>
<%!
	static final int si_title 		= SI("Изменение пароля пользователя","","","");
	static final int si_save			= SI("Сохранить","Саклаш","Saqlash","Save");
	static final int si_old_pwd		= SI("Введите старый пароль","","","");
	static final int si_pwd				= SI("Введите новый пароль","","","");
	static final int si_new_pwd		= SI("Подтверждение пароля","","","");
	static final int si_success		= SI("Успешно выполнено!","Мувоффакиятли бажарилди!","Muvoffaqiyatli bajarildi!","Successfully executed!");
//-------------------------------------------------------------------------------------------------
