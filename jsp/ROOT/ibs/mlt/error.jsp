...
%><t:form title="<%=(template_id!=null)?si_edit_title:si_add_title%>" minWidth="fill" minHeight="fill">
	...
	<div id="basepanel" class="panel">
		...
		<form name="fm" method="post" action="error.jsp?process_code=SAVE_ERROR_WITH_TEMPLATE" target="frm"
			...
			<div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:5px">
				...
				<div class="form-group">
					<input name="error_code" mask="number" r="1" class="form-control" readonly>
					<label><%=lang.get(si_error_code)%> <q></q>:</label>
				</div>
			</div>
			<div style="display:grid;grid-template-columns:4fr 1fr;gap:5px">
				<div class="form-group">
					<input name="description" r="1" mask="120|" class="form-control">
...
<%!
	...
	static final int si_lang5 = SI("Каракалпакский", "Qoraqalpoqcha", "Коракалпокча", "Karakalpak");
