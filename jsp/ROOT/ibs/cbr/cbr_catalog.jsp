...
<%!
    ...
    static final int si_interval_15min = SI("Каждые 15 минут", "?ар 15 да?и?ада", "Har 15 daqiqada", "Every 15 minutes");
    static final int si_interval_1hour = SI("Каждый час", "?ар соатда", "Har soatda", "Every hour");
    static final int si_interval_6hour = SI("Каждые 6 часов", "?ар 6 соатда", "Har 6 soatda", "Every 6 hours");
    static final int si_interval_1day  = SI("Каждый день", "?ар куни", "Har kuni", "Every day");
    static final int si_interval_10day = SI("Каждые 10 дней", "?ар 10 кунда", "Har 10 kunda", "Every 10 days");
    static final int si_interval_1month = SI("Каждый месяц", "?ар ойда", "Har oyda", "Every month");
    static final int si_interval_1year = SI("Каждый год", "?ар йилда", "Har yilda", "Every year");
    static final int si_save_schedule  = SI("Сохранить", "Са?лаш", "Saqlash", "Save");
    static final int si_refresh_now    = SI("Обновить сейчас", "?озир янгилаш", "Hozir yangilash", "Refresh now");
    ...
    static final int si_status_ok      = SI("успешно", "муваффа?иятли", "muvaffaqiyatli", "success");
